...
public class MovingZone : InteractableEnter
{
    [SerializeField] private TypeBattersPlatform _typeBatters;
    [SerializeField] private TypeDeadZonePlatform _typeDeadZone;
    ...
    {
        if (_typeDeadZone == TypeDeadZonePlatform.DeadZone)
        {
...
public enum TypeDeadZonePlatform
{
    DeadZone,
    Platform
}
